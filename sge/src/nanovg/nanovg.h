...
// Return the index of saved state
int nvgSave(NVGcontext* ctx);

// Pops and restores current render state to the indexed state. if less than 0 mean back count
void nvgRestore(NVGcontext* ctx, int index);
